...
st.markdown(
    """
This dashboard is a **portfolio showcase** built on a real data pipeline that
scrapes public [Final Fantasy XIV](https://www.finalfantasyxiv.com) Party Finder
listings from [xivpf.com](https://xivpf.com). It is meant to demonstrate a
